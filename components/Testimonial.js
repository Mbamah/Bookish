...
const Testimonial = () => {
  return (
    <section class="bg-white font-['Numans']">
      <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8 sm:py-24">
        <div class="max-w-xl mx-auto text-center">
          <h2 class="text-4xl font-medium text-gray-900 tracking-tight sm:text-5xl">
        ...
        <div class="grid grid-cols-1 gap-8 pt-16 mt-16 border-t border-gray-100  sm:grid-cols-2 lg:grid-cols-3 sm:gap-16">
